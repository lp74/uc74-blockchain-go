...
% \begin{mdframed}[backgroundcolor=backcolour,linewidth=0pt] 
...
% di <math>H</math> in <math>G</math>; questo forma una [[Partizione (teoria degli insiemi)|partizione]] di <math>G</math>, ovvero <math>G</math> è unione delle classi laterali, e due classi laterali distinte non hanno elementi in comune. Inoltre per ogni <math>a \in G</math> la funzione <math>H \to a H</math> che manda <math>h \in H</math> in <math>a h</math> è una [[biezione]].
\end{dimostrazione}
...
\begin{itemize}
    ...
    \item la chiave pubblica può verificare che il messaggio sia stato firmato attraverso la chiave privata senza conoscerla: % verify(pubKey, hashed_message, signature)
\end{itemize}
